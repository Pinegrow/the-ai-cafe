...
<template>
  <div>
    <section class="flex justify-center w-full">
      <v-banner icon="$warning" color="warning" class="max-w-3xl mt-4">
        <v-banner-text>
          This is the home page with image optimizations using @nuxt/image
          module.
        </v-banner-text>
      </v-banner>
    </section>
